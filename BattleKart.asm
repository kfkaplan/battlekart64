...
.definelabel VARIABLE_RAM_BASE,  0x80450000// ////Place in ram to store all the battle kart variables
...
detectEmulator:
	LW a0, 0x80500000 //Chunk of ram to check
